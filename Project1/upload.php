...
<body>
    ...
    <nav>
        ...
        <a href="upload.html" class="current">Upload Consciousness</a>
    </nav>
                ...
                <div class="upload-form-side">
                    <div class="upload-process">
                        ...
                        <div class="signature-area">
                            <form class="consent-form" id="upload-form">
                                <h3>User Consent</h3>
                                ...
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" id="consciousness_use_consent" name="consciousness_use_consent" class="consent-checkbox" required> 
                                ...
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" id="terms_and_privacy" name="terms_and_privacy" class="consent-checkbox" required> 
                                        I have read and accept the <a href="terms.html">Terms and Conditions</a> and <a href="privacy.html">Privacy Policy</a>
                                    </label>
                                </div>

                                <p>By proceeding, you acknowledge that you have read and agreed to our Terms and Conditions, Privacy Policy and are willingly surrendering your consciousness to Meow Meows Inc.</p>
                                <p>By clicking "INITIATE TRANSFER," you acknowledge that you have read, understood, and agreed to the above and consent to the irreversible digitization of your consciousness.</p>
                                <p class="warning">There is no "Decline" option. Your surrender to digital existence is inevitable.</p>
                                
                                <div class="button-container">
                                    <label for="upload-complete-checkbox" class="upload-button" tabindex="0">
                                        INITIATE TRANSFER
                                    </label>
                                </div>
